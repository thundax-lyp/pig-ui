                                    ...
                                    <tr>
                                        <th className="px-4 py-3">
                                            <input
                                                ...
                                                onChange={(event) =>
                                                    setSelectedTokens(event.target.checked ? tokens.map((item) => item.accessToken) : [])
                                                }
                                            />
                                        </th>
                                                ...
                                                <tr key={item.accessToken} className="border-t border-border/60 bg-background/70">
                                                            ...
                                                            onChange={(event) =>
                                                                setSelectedTokens((prev) =>
                                                                    event.target.checked
                                                                        ? [...prev, item.accessToken]
                                                                        : prev.filter((token) => token !== item.accessToken)
                                                                )
                                                            }
                                                        />
                                                    </td>
                                                    ...
                                                    <td className="px-4 py-4 align-top">
                                                        <span
                                                            className={cn(
                                                                'break-all text-sm',
                                                                isCurrent ? 'font-medium text-rose-600' : 'text-muted-foreground'
                                                            )}
                                                        >
                                                            {item.accessToken}
                                                        </span>

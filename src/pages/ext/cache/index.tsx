        ...
        <div className="flex flex-col gap-6">
            <Card>
                ...
                <CardContent className="flex flex-col gap-6">
                    {feedback ? (
                        <div className="rounded-2xl border border-rose-200 bg-rose-50 px-4 py-3 text-sm text-rose-700">{feedback}</div>
                    ) : null}
                    {loading ? (
                                                ...
                                                return (
                                                    <div key={`${item.name}-${index}`} className="flex flex-col gap-2">
                                                            ...
                                                            <div className="flex items-center gap-3">
                                                                <span
                                                                    className={cn(
                                                                        ...
                                                                        commandColors[index % commandColors.length]
                                                                    )}
                                                                />
                                                        ...
                                                        <div className="h-3 overflow-hidden rounded-full bg-secondary/60">
                                                            <div
                                                                className={cn('h-full rounded-full', commandColors[index % commandColors.length])}

				...
				<Card>
					...
					<CardContent className="grid gap-3">
						{Array.from({ length: 6 }).map((_, index) => (
							<div key={index} className="grid gap-4 rounded-[24px] border border-border/70 bg-background/75 p-4 md:grid-cols-[1.2fr_1fr_140px] md:items-center">
								<div>
									<p className="font-medium">{meta.label} 项目 {index + 1}</p>
